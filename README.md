...
## 🔐 Cybersecurity & Privacy — [Torito](https://torito.io)

> Security and privacy tools for real-world threats.

| Project | Description |
|---|---|
| [**SupaExplorer**](https://supaexplorer.com) | Scan your Supabase project for exposed credentials and API key leaks in 30 seconds |
| [**CertPatrol**](https://github.com/ToritoIO/CertPatrol) | Lightweight Certificate Transparency log tailer — filter domains with regex, run locally, no tracking |
| [**Beacky**](https://beacky.com) | Invisible protection against phishing and site cloning — deploy beacons, get alerted if your site is copied |
| [**Datos Argentinos – Safe ID**](https://datosargentinos.com) | Protect your ID with smart watermarks and sensitive data obfuscation. Free & instant |
| [**HACKER**](https://hacker.com.ar) | Cybersecurity learning hub with resources, tools, and a structured roadmap |
| [**RZW**](https://www.rzw.com.ar) | Information security blog — online since 2002 |
...
## 🐾 Pet · 🔍 Career · 🧒 Kids · 💻 Code

| Project | Description |
|---|---|
| **Waulog** | Your dog's digital companion for tracking health and care |
| [**LinProfi**](https://linprofi.com) | Free job tracker with CV and cover letter builders |
| [**Spielplätze in Deutschland**](https://spielplaetze.co) | Germany's largest playground catalog — find playgrounds near you |
| [**SIDE**](https://side.com.ar) | Archivos históricos de la Secretaría de Inteligencia de Estado, 1973–1983 |
| [**COBOL**](https://cobol.com.ar) | COBOL programming language resources & documentation |

---

> *And 20+ more projects in stealth mode.*
